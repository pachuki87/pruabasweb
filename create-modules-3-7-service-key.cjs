...
// Mapeo de módulos del PDF con lecciones existentes en Supabase
const moduloLeccionMap = {
  3: 3, // Módulo 3 -> Lección ID 3
  4: 4, // Módulo 4 -> Lección ID 4
  5: 5, // Módulo 5 -> Lección ID 5
  6: 6, // Módulo 6 -> Lección ID 6
  7: 7  // Módulo 7 -> Lección ID 7
};
