...
const MODULO_LECCION_MAP = {
  3: '5cc8702c-45ab-4ae4-8e9a-df1d5c2c6e44', // Lección 3
  4: '8cae572b-b3e8-4ba4-90e3-b45a4f7c428a', // Lección 4  
  5: '9d4e5f6a-7b8c-9d0e-1f2a-3b4c5d6e7f8a', // Lección 5
  6: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', // Lección 6
  7: 'b2c3d4e5-f6a7-8901-bcde-f23456789012'  // Lección 7
};
...
async function crearCuestionario(moduloNum, leccionId, titulo) {
  ...
  const { data: cuestionario, error } = await supabase
    ...
    .insert({
      titulo: titulo,
      curso_id: 'b47d4c8e-8f2a-4d5b-9c1e-2f3a4b5c6d7e', // ID del curso "Máster en Adicciones"
