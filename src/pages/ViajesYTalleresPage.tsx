  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-lidera-light-blue to-[#6a96c0] text-white py-16 overflow-hidden">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-8 text-center">
                  <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-lidera-light-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* CTA Section */}
            <div className="bg-lidera-light-blue rounded-lg text-white p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-lidera-light-blue px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                  Contactar por Email
                </button>
                <button className="bg-[#6a96c0] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#5a86b0] transition-colors">
                  Llamar Ahora
                </button>
              </div>
            </div>
