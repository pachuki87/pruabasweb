  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Ideas & Conocimiento</h2>
          <p className="text-xl text-gray-600">Investigación e insights de nuestros expertos</p>
        </div>
